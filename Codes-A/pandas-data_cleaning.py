...
df = pd.read_csv('D:\\IIITN\\Session2021-22\\Odd\\ITW1\\StudentsPerformance.csv')
...
# df = pd.read_csv('D:\\IIITN\\Session2021-22\\Odd\\ITW1\\StudentsPerformance1.csv')
# df.fillna(130, inplace = True)
# print(df.to_string())

# Filling a specific value in a specific column
df = pd.read_csv('D:\\IIITN\\Session2021-22\\Odd\\ITW1\\StudentsPerformance3.csv')
